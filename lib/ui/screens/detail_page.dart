...
import 'package:netflix_ui_change_app/bloc/movies_detail_bloc.dart';
import 'package:netflix_ui_change_app/model/genre_model.dart';
import 'package:netflix_ui_change_app/model/movie_detail_model.dart';
import 'package:netflix_ui_change_app/model/production_country_model.dart';
import 'package:netflix_ui_change_app/ui/widget/movie_gallery.dart';
...
class _MovieDetailPageState extends State<MovieDetailPage> {
  ...
  _buildMovieInfo(BuildContext context, String year,
      List<ProductionCountryModel> productionCountry, int length) {
